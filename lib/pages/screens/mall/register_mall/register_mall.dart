...
class RegisterMallDetailScreen extends StatefulWidget {
  ...
  @override
  State<RegisterMallDetailScreen> createState() => _RegisterMallDetailScreenState();
}
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const SizedBox(height: 10,),
                    Text('Ảnh chụp cùng giấy tờ',style: context.theme.textTheme.headlineMedium?.copyWith(
                        fontWeight: FontWeight.bold
                    ),),
                    Container(
                      margin: const EdgeInsets.symmetric(vertical: 10),
                    ...
                    Text("Ngân hàng",style: context.theme.textTheme.headlineSmall?.copyWith(
                        fontWeight: FontWeight.w600
                    ),),
                    Container(
                      margin: const EdgeInsets.symmetric(vertical: 10),
                    ...
                    const CustomTextFieldNoIcon(label: "Số Tài khoản",hintText:"Điển thông tin tại đây"),
                    Text("Thẻ tín dụng hoặc thẻ ghi nợ (nếu có)",style: context.theme.textTheme.headlineSmall?.copyWith(
                        fontWeight: FontWeight.w600
                    ),),
                    Container(
                      margin: const EdgeInsets.symmetric(vertical: 10),
                    ...
                    const CustomTextFieldNoIcon(label: "Mô tả shop",hintText:"Điển thông tin tại đây",line: 7,),
                    Row(
                      children: [
                        Checkbox(
                        ...
                        Text.rich(
                            TextSpan(
                                ...
                                children: const [
                                  ...
                                  TextSpan(text: " điều khoản và điều kiện",style: TextStyle(
                                      color: Styles.blue
                                  )),
                                ]
                            )
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: TextButton(
                              onPressed: () {
                                Navigator.push(context, MaterialPageRoute(builder: (context) =>const UserMailDetailsShop(),));
                              },
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.transparent,
                                elevation: 0,
                              ...
                              ), child: const Text("Đăng ký mall",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
                            ),
                          ),
                        ),
                      ],
                    ...
                    Align(
                      ...
                      child: Text("Xem chi tiết quyền lợi",style: context.theme.textTheme.headlineSmall?.copyWith(
