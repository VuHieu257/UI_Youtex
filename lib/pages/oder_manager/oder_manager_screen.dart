...
class OrderManagementScreen1 extends StatelessWidget {
  const OrderManagementScreen1({super.key});
  @override
                            ...
                            children: [
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                        Asset
                                            .bgImageProduct, // Replace with actual image
                                      ),
                                      fit: BoxFit.cover,
                                    )),
                              ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    infoOrder(
                                        context, 'Mã đơn hàng', '356106AHB8'),
                                    infoOrder(
                                        context, 'Người đặt', 'Nguyễn Văn A'),
                                    infoOrder(context, 'Ngày tạo',
                                        ' 16:10  10/10/2024'),
                                    infoOrder(context, 'Tình trạng đơn hàng',
                                        'Chờ vận chuyển'),
                                    infoOrder(context, 'Phương thức thanh toán',
                                        'TKNH/TTD'),
                                    infoOrder(context, 'Tổng giá trị đơn hàng ',
                                        '1.987.000đ',
                                        color: 0xff113A71),
                                  ],
                                ),
  ...
  Padding infoOrder(BuildContext context, String textTitle, String textContent,
      {int? color}) {
    return Padding(
